...
REBUILD="false"
MAX_SYMBOLS=""
LOG_ROOT="$REPO_ROOT/batch-jobs/yahoo-daily-bars-data/LOG/showmeedge-sp500-eod"
...
Options:
  ...
  --log-root PATH              Host log root. Default: batch-jobs/yahoo-daily-bars-data/LOG/showmeedge-sp500-eod
