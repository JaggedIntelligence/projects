...
export function DebugPanel() {
  ...
  const systemLayoutClassName = isBottomDock
    ? "grid min-h-full content-start gap-3 pr-1 xl:grid-cols-3"
    : "h-full space-y-3 overflow-y-auto pr-1"
        ...
        >
          <div className={systemLayoutClassName}>
            <DebugSection
              ...
              description="Raw locale signals and Intl formatting defaults from the host environment."
            >
              <KeyValueGrid
                entries={[
                  [
                  ...
                  ["Navigator", localeDefaults.navigatorLanguage],
                  ["Intl locale", localeDefaults.intlLocale],
                  ["Region", localeDefaults.region ?? "Unavailable"],
                  ["Time zone", localeDefaults.timeZone],
                  ["Calendar", localeDefaults.calendar],
                  ["Numbering", localeDefaults.numberingSystem],
                  ["Hour cycle", localeDefaults.hourCycle],
                  [
                    "12-hour",
                  ...
                  ["First day", localeDefaults.firstDayOfWeek],
                  ["HTML lang", localeDefaults.documentLang],
                  ["HTML dir", localeDefaults.documentDir],
                ]}
              />
            </DebugSection>
            ...
            <DebugSection
              ...
              description="Default user preference signals from media queries."
            >
              <KeyValueGrid
                entries={[
                  ["Color scheme", accessibilityDefaults.colorScheme],
                  ["Reduced motion", accessibilityDefaults.reducedMotion],
                  ["Contrast", accessibilityDefaults.contrast],
                  ["Forced colors", accessibilityDefaults.forcedColors],
                  ["Inverted colors", accessibilityDefaults.invertedColors],
                  ["Transparency", accessibilityDefaults.reducedTransparency],
                ]}
              />
            </DebugSection>
            ...
            <DebugSection
              ...
              description="Pointer, touch, and browser platform defaults."
            >
              <KeyValueGrid
                entries={[
                  ["Platform", inputDefaults.platform],
                  ["Touch points", inputDefaults.maxTouchPoints],
                  ["Touch capable", String(inputDefaults.touchCapable)],
                  ["Pointer", inputDefaults.pointer],
                  ["Any pointer", inputDefaults.anyPointer],
                  ["Hover", String(inputDefaults.hover)],
                  ["Any hover", String(inputDefaults.anyHover)],
                  [
                    "CPU threads",
                  ...
                  ["User agent", inputDefaults.userAgent],
                ]}
              />
            </DebugSection>
            ...
            <DebugSection
              ...
              description="Default viewport, screen, and media capability signals."
            >
              <KeyValueGrid
                entries={[
                  ["Viewport", displayDefaults.viewport],
                  ["Screen", displayDefaults.screen],
                  ["Available", displayDefaults.availableScreen],
                  ["DPR", displayDefaults.devicePixelRatio],
                  ["Orientation", displayDefaults.orientation],
                  ["Color gamut", displayDefaults.colorGamut],
                  ["Dynamic range", displayDefaults.dynamicRange],
                  ["Monochrome", String(displayDefaults.monochrome)],
                ]}
              />
            </DebugSection>
            ...
            <DebugSection
              ...
              description="Baseline connectivity and network preference hints from the browser."
            >
              <KeyValueGrid
                entries={[
                  ["Online", String(networkDefaults.online)],
                  ["Effective type", networkDefaults.effectiveType],
                  [
                    "Save-Data",
            ...
            <DebugSection
              ...
              description="Normalized summaries that explain the current host defaults."
            >
              <KeyValueGrid
                entries={[
                  [
                    "Locale trace",
                    localeDefaults.localeChain.length
                      ? `${localeDefaults.localeChain.join(" → ")} → ${localeDefaults.intlLocale}`
                      : localeDefaults.intlLocale,
                  ],
                  [
                    "Formatting trace",
                    `${localeDefaults.timeZone} · ${localeDefaults.calendar} · ${localeDefaults.numberingSystem} · ${localeDefaults.hourCycle}`,
                  ],
                  [
                    "Accessibility trace",
                    `${accessibilityDefaults.colorScheme} · motion ${accessibilityDefaults.reducedMotion} · contrast ${accessibilityDefaults.contrast}`,
                  ],
                  [
                    "Input trace",
                    `${inputDefaults.pointer} pointer · hover ${inputDefaults.hover ? "yes" : "no"} · touch ${inputDefaults.touchCapable ? "yes" : "no"}`,
                  ],
                  [
                    "Display trace",
                    `${displayDefaults.orientation} · ${displayDefaults.colorGamut} gamut · ${displayDefaults.dynamicRange} dynamic range`,
                  ],
                  [
                    "Network trace",
                    networkDefaults.online
                      ? `${networkDefaults.effectiveType} · save-data ${networkDefaults.saveData === null ? "?" : networkDefaults.saveData ? "on" : "off"}`
                      : "offline",
                  ],
                ]}
              />
